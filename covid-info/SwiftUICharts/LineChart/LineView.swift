        ...
        GeometryReader{ geometry in
            VStack(alignment: .leading, spacing: 8) {
                ...
                ZStack{
                    ...
                    .frame(width: geometry.frame(in: .local).size.width, height: 120)
                    .offset(x: 0, y: 20 )
                ...
                .onChanged({ value in
                    ...
                    self.opacity = 1
                    self.closestPoint = self.getClosestDataPoint(toPoint: value.location, width: geometry.frame(in: .local).size.width-30, height: 120)
