...
public struct BarChartView : View {
    ...
    public var body: some View {
        ZStack{
            ...
            VStack(alignment: .leading){
                ...
                BarChartRow(data: data.points.map{$0.value},
                ...
                if self.legend != nil  && self.formSize == ChartForm.medium && !self.showLabelValue{
                    ...
                    LabelView(arrowOffset: self.getArrowOffset(touchLocation: self.touchLocation),
                              title: .constant(self.getCurrentValue()!.key))
            ...
            .gesture(DragGesture()
                .onChanged({ value in
                    ...
                    self.showValue = true
                    self.currentValue = self.getCurrentValue()?.value ?? 0
    ...
    func getCurrentValue() -> ChartDataPoint? {
