...
public struct ChartForm {
    ...
    #else
    public static let small = CGSize(width:150, height:150)
    public static let medium = CGSize(width:180, height:240)
    public static let large = CGSize(width:320, height:200)
...
public class ChartStyle {
    ...
    public var lineBackgroundGradient : Gradient = Gradient(colors: [Colors.GradientUpperBlue, .white])
    ...
    public init(backgroundColor: Color, accentColor: Color, gradientColor: GradientColor, textColor: Color, legendTextColor: Color, dropShadowColor: Color, lineBackgroundGradient: Gradient){
        self.backgroundColor = backgroundColor
        self.accentColor = accentColor
        ...
        self.legendTextColor = legendTextColor
        self.dropShadowColor = dropShadowColor
        self.lineBackgroundGradient = lineBackgroundGradient
    }
...
public class ChartDataPoint: Equatable, Comparable {
...
public class ChartData: ObservableObject, Identifiable {
    ...
    public init<N: BinaryFloatingPoint>(points:[N]) {
        self.points = points.map{ChartDataPoint(key:"", value:Double($0))}
    }
    public init<N: BinaryInteger>(values:[(String,N)]){
        self.points = values.map{ChartDataPoint(key:$0.0, value:Double($0.1))}
    ...
    public init<N: BinaryInteger>(numberValues:[(N,N)]){
        self.points = numberValues.map{ChartDataPoint(key:String($0.0), value:Double($0.1))}
        self.valuesGiven = true
    }
    ...
    public init(points:[ChartDataPoint]) {
        self.points = points
        self.valuesGiven = true
    }
